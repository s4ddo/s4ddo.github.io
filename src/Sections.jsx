...
const SectionContent = {
  [Sections.GraphicDesign]: {
    Overview: () => (
      <BasicOverview
        ...
        description={`Back in highschool I did a loooooot of work for my student council as a graphic designer.
                            ...
                            still suck at it`}
        domElement={
          <Picture folder={"graphic_design"} fileName={"overview.gif"} />
        }
      />
    ),
    ...
    "Landscape Posters": () => (
      <GalleryGenerator folder={"posters_landscape"} />
    ),
  ...
  [Sections.Programming]: {
    Overview: () => (
      <BasicOverview
        ...
        domElement={
          <Picture folder={"code_projects/overview"} fileName={"0.JPG"} />
        }
      />
    ),
    ...
    "AI Flocking Agents": () => (
      <BasicOverview
        ...
        domElement={
          <Picture
            width={"50%"}
            folder={"code_projects/agent_ai"}
            fileName={"agent_ai.gif"}
          />
        }
      />
    ),
    ...
    "kiokugame.com": () => (
      <BasicOverview
        ...
        domElement={
          <Picture
            folder={"code_projects/kiokugamecom"}
            fileName={"kiokugamecom.gif"}
          />
        }
      />
    ),
    ...
    SpotifyV2: () => (
      <BasicOverview
        ...
        domElement={
          <Picture
            width={"50%"}
            folder={"code_projects/spotifyv2"}
            fileName={"spotify.gif"}
          />
        }
      />
    ),
  ...
  [Sections.Games]: {
    ...
    MoonlightPeaks: () => (
      <BasicOverview
        ...
        subtitle={"Animal Crossing but Vampires"}
        sub_subtitle={"https://moonlightpeaks.com"}
        technologies={
          "C# | UNITY | PLASTICSCM | SCRUMWISE | STEAMWORKS SDK | TEAMSIZE: 22"
        }
        description={`Moonlight Peaks is cozy life-sim video game reminiscent to popular games such as Animal Crossing & Stardew Valley. The game
        was developed for Nintendo Switch & Steam by the studio Little Chicken where I interned there for about 6 months as a game dev and content designer.
        Honestly and awesome game and learnt so much during my time there.`}
        s
        domElement={<YouTubeEmbed video_id={"FEL1rn69Z7Y"} />}
      />
    ),
    ...
    Kioku: () => (
      <BasicOverview
        ...
        sub_subtitle={"https://kiokugame.com"}
        technologies={
          "C# | UNITY | FIREBASE | BLENDER | PS | STEAMWORKS SDK | GIT "
        }
        description={`Kioku is a rhythmy souls-rouge like indie game (Yeah we know alot of words there...). Crafted 
            ...
            both pc and mobile in parallel.`}
        s
...
export function PopUp({
  ...
  return (
    <div
      className={`popup ${
        currentTarget.x < 0 ? "right fadeinleft" : "fadeinright"
      }`}
    >
      <ButtonToolbar
